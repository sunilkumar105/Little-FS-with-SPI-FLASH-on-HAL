...
#include "Datalogger_Configurations/datalogger_configurations.h"
#include <stdio.h>
#include <string.h>
...
bool appendDataAtTheEndOfFile(const char*fileName, const char*dataBuffer,
	...
	printf ("[ ERROR ] allocating memory of size %u for appending file %s \r\n",
